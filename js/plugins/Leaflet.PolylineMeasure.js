    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        _drawArrow: function (arcLine) {
            ...
            var iconArrow = L.divIcon ({
                ...
                iconSize: [16, 16],
                iconAnchor: [8, 8],
                   // html : "<img src='/img/' style='background:green; height:100%; vertical-align:top; transform:rotate("+ cssAngle +"deg)'>"  //<<=== alternative method by the use of an image instead of a Unicode symbol.
